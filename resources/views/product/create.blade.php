        ...
        <div class="col-md-12">
            ...
            <div class="card p-2">
                ...
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control date" id="description" name="description" placeholder="Description">{{ old('description') }}</textarea>
                                @error('description')
                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="selling_price" name="selling_price" placeholder="0.00" value="{{ old('selling_price') }}">
                                @error('selling_price')
                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="special_price" name="special_price" placeholder="0.00" value="{{ old('special_price') }}">
                                @error('special_price')
                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input type="radio" name="is_delivery_available" id="status_inactive" value="0" class="form-check-input">
                    ...
                    <input type="hidden" name="pro_attr_array" id="pro_attr_array">
